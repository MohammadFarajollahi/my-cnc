...
namespace LaserGRBL
{
	public partial class MainForm : Form
	{
		...
		{
			//label1.Text = Strings.MainFormEstimatedTime;
			SuspendLayout();
		...
		protected override void OnKeyUp(KeyEventArgs e)
		{
			...
			base.OnKeyUp(e);
			//label2.Text = mLastkeyData.ToString;
		}
		...
		private void MnGrbl_Click(object sender, EventArgs e)
		{
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
			if (Core.rv!="")
            {
				if (Core.rv=="<Idle|WPos:0.000,0.000,0.000|FS:0,0|Pn:S>")
                {
					Core.RunProgram(this);
				}
				label4.Text = Core.rv.ToString();
