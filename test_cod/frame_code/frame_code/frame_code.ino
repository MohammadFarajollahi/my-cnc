...
void setup() {
  ...
  //listDir(SD, "/", 0);
  // removeDir(SD, "/mydir");
  //listDir(SD, "/cnc files", 0);
  writeFile(SD, "/resume.txt", "G0 X4.167 Y11.167 S0");
  // appendFile(SD, "/hello.txt", "World!\n");
  //readFile(SD, "/cnc files/file_mohammad.nc");
  readFile(SD, "/files/ali.nc");
  //readFile(SD, "/resume.txt");
  // readFile(SD, "/gcod2.txt");
